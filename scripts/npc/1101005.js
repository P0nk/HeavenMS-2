...
*/
/* 
    1101005 - Irena, Henesys Park
    |- Repurposed to serve as Archer Skill helper
 */

var status;
var options = ["Explain my skills.", "Reset my skills.", "I'm good, thanks."];
var defaultText = "I am Irena, the Archer Skill Expert. I can only offer help to fellow Archers.";
var archerText = "Greetings, young one. I am Chief Knight Irena. Do you desire knowlege of the bow? I offer what wisdom I can.";
