...
public class MushroomShrine extends GachaponItems {
    ...
    public int[] getCommonItems() {
        return new int[]{
                ...
                /* Warrior equipment */
                1060074, 1322002, 1002340, 1442004, 1422008, 1050022,
                ...
                /* Thief equipment */
                1060052, 1472013, 1002180, 1002170, 1060073, 1060099, 1332032,
    ...
    public int[] getUncommonItems() {
        return new int[]{2040811, 2040810, 2040815, 2040814,
                3010019};
    }

    @Override
    public int[] getRareItems() {
        return new int[]{1372039, 1432018, 1102086};
    }
