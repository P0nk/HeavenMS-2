...
*/
/* 
    1101003 - Mihile, Perion
    |- Repurposed to serve as Warrior Skill helper
 */

var status;
var options = ["Explain my skills.", "Reset my skills.", "I'm good, thanks."];
var defaultText = "I am Mihile, the Warrior Skill Expert. I can only assist those that have chosen the path of the Warrior.";
var warriorText = "Hello, warrior. I am Chief Knight Mihile. I offer my services to young swordsmen looking to hone their skills.";
